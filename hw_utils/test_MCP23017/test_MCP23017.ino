#define BTN_NUM_COL  	1
#define BTN_NUM_ROW 	1
...
static uint8_t btn_select_pins[BTN_NUM_COL] = {0}; // ground switch
static uint8_t btn_read_pins[BTN_NUM_ROW] = {0};
