...
//		_clk_div_ui[i].init_animation_n_save(param::get_led_matrix(),(CLK_DIVIDER_LED_OFFSET+i), LED_R_IDX);
...
//		_clk_mul_ui[i].init_animation_n_save(param::get_led_matrix(),(CLK_MULTIPLIER_LED_OFFSET+i), LED_R_IDX);
